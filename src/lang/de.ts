...
const deMessages = {
  ...
  slides: {
    ...
    textboxEditHint: "Textfeldinhalt bearbeiten (Titel / Thank You / ausgecheckte Seiten ausgenommen)",
    textboxNotEditable: "Der Text dieser Seite kann nicht bearbeitet werden (Titel / Thank You / ausgecheckt)",
    ...
    pickAsset: "Asset einfügen",
    pickAssetHint: "Icon-/Bildbibliothek öffnen und eines einfügen",
  },
  assetPicker: {
    title: "Asset auswählen",
    icons: "Icons",
    images: "Bilder",
    search: "Nach Stichwort filtern",
    empty: "Keine passenden Assets",
    select: "Auswählen",
    cancel: "Abbrechen",
    loading: "Wird geladen…",
    loadError: "Assets konnten nicht geladen werden",
    picked: "Ausgewählt: {label}",
    cancelledMessage: "Asset-Auswahl abgebrochen.",
  },
  mulmoPoint: {
