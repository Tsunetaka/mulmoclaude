...
const frMessages = {
  ...
  slides: {
    ...
    textboxEditHint: "Modifier le contenu de la zone de texte (couverture / Thank You / pages extraites exclues)",
    textboxNotEditable: "Le texte de cette page ne peut pas être modifié (couverture / Thank You / extraite)",
    pageMoveUp: "Monter",
    ...
    pickAsset: "Insérer une ressource",
    pickAssetHint: "Ouvrir la bibliothèque d'icônes / images et en insérer une",
  },
  assetPicker: {
    ...
    picked: "Sélectionné : {label}",
    cancelledMessage: "Sélecteur de ressources annulé.",
  },
  mulmoPoint: {
