...
const esMessages = {
  ...
  slides: {
    ...
    textboxEditHint: "Editar el contenido del cuadro de texto (portada / Thank You / páginas desprotegidas excluidas)",
    textboxNotEditable: "El texto de esta página no se puede editar (portada / Thank You / desprotegida)",
    pageMoveUp: "Subir",
    pageMoveDown: "Bajar",
    pageDelete: "Eliminar",
    ...
    pickAsset: "Insertar recurso",
    pickAssetHint: "Abrir la biblioteca de iconos / imágenes e insertar uno",
  },
  assetPicker: {
    title: "Seleccionar un recurso",
    icons: "Iconos",
    images: "Imágenes",
    search: "Filtrar por palabra clave",
    empty: "No hay recursos coincidentes",
    select: "Seleccionar",
    cancel: "Cancelar",
    loading: "Cargando…",
    loadError: "No se pudieron cargar los recursos",
    picked: "Seleccionado: {label}",
    cancelledMessage: "Se canceló el selector de recursos.",
  },
  mulmoPoint: {
    title: "Acerca de MulmoPoint",
    description: "Sistema de créditos de IA que impulsa las funciones de generación de MulmoClaude.",
    aiEngines: "Motores de IA",
    slideEditing: "Edición de diapositivas",
