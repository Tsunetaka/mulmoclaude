...
const koMessages = {
  ...
  slides: {
    ...
    textboxEdit: "텍스트 편집",
    textboxEditHint: "텍스트 상자 내용 편집 (표지 / Thank You / 체크아웃 페이지 제외)",
    textboxNotEditable: "이 페이지의 텍스트는 편집할 수 없습니다 (표지 / Thank You / 체크아웃 중)",
    pageMoveUp: "위로 이동",
    pageMoveDown: "아래로 이동",
    pageDelete: "삭제",
    pageAdd: "페이지 추가",
    ...
    sectionAdd: "섹션 추가",
    pickAsset: "에셋 삽입",
    pickAssetHint: "아이콘/이미지 라이브러리를 열어 하나 삽입",
  },
  assetPicker: {
    title: "에셋 선택",
    icons: "아이콘",
    ...
    cancel: "취소",
    loading: "불러오는 중…",
    loadError: "에셋을 불러오지 못했습니다",
    picked: "선택함: {label}",
    cancelledMessage: "에셋 선택을 취소했습니다.",
  },
  mulmoPoint: {
    title: "MulmoPoint 정보",
