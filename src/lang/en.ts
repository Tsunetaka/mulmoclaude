...
const enMessages = {
  ...
  slides: {
    ...
    textboxEditHint: "Edit text box contents (cover / Thank You / checked-out pages excluded)",
    textboxNotEditable: "This page's text can't be edited (cover / Thank You / checked out)",
    pageMoveUp: "Move up",
    ...
    pickAsset: "Insert asset",
    pickAssetHint: "Open the icon / image library and insert one",
  },
  assetPicker: {
    ...
    cancelledMessage: "Cancelled the asset picker.",
  },
  mulmoPoint: {
