...
const jaMessages = {
  ...
  slides: {
    ...
    textboxEdit: "テキスト編集",
    textboxEditHint: "テキストボックスの文字列を編集（表紙／Thank You／チェックアウト頁は対象外）",
    textboxNotEditable: "この頁のテキストは編集できません（表紙／Thank You／チェックアウト中）",
    pageMoveUp: "上へ移動",
    pageMoveDown: "下へ移動",
    pageDelete: "削除",
    pageAdd: "頁追加",
    ...
    sectionAdd: "セクション追加",
    pickAsset: "アセット挿入",
    pickAssetHint: "アイコン/画像ライブラリを開いて1点挿入",
  },
  assetPicker: {
    title: "アセットを選択",
    icons: "アイコン",
    images: "画像",
    search: "キーワードで絞り込み",
    empty: "該当するアセットがありません",
    select: "選択",
    cancel: "キャンセル",
    loading: "読み込み中…",
    loadError: "アセットの読み込みに失敗しました",
    picked: "選択しました: {label}",
    cancelledMessage: "アセット選択をキャンセルしました。",
  },
  mulmoPoint: {
