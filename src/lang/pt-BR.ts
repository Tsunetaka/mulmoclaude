...
const ptBRMessages = {
  ...
  slides: {
    ...
    textboxEditHint: "Editar o conteúdo da caixa de texto (capa / Thank You / páginas com check-out excluídas)",
    textboxNotEditable: "O texto desta página não pode ser editado (capa / Thank You / em check-out)",
    ...
    pickAsset: "Inserir recurso",
    pickAssetHint: "Abrir a biblioteca de ícones / imagens e inserir um",
  },
  assetPicker: {
    title: "Selecionar um recurso",
    icons: "Ícones",
    images: "Imagens",
    ...
    cancel: "Cancelar",
    loading: "Carregando…",
    loadError: "Falha ao carregar os recursos",
    picked: "Selecionado: {label}",
    cancelledMessage: "Seleção de recurso cancelada.",
  },
  mulmoPoint: {
